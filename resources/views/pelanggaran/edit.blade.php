...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h1 class="mb-4 mt-4 text-uppercase text-center fw-bold">EDIT DATA PELANGGARAN SISWA</h1>
            <div class="card">
                @if ($errors->any())
                    ...
                    <form action="{{ route('pelanggaran.update', $pelanggaran->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="kelas_id" name="kelas_id" required>
                                ...
                                @foreach($kelas as $k)
                                    <option value="{{ $k->id }}" {{ $pelanggaran->kelas_id == $k->id ? 'selected' : '' }}>{{ $k->nama_kelas }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="text-left">
